...
disk_tip = "Disk space utilization: "+str(disk_usage)+"%"
print(disk_tip)

mem_usage = get_mem_usage_percent()
mem_usage = int(mem_usage[0])
mem_tip = "Physical memory utilization: "+str(mem_usage)+"%"
print(mem_tip)

cpu_usage = int(get_cpu()*100)
cpu_tip = "CPU utilization: "+str(cpu_usage)+"%"
print(cpu_tip)

load_average = os.getloadavg()
load_tip = "System load (One of the three values above 3 is the height): "+str(load_average)
print(load_tip)